...
var selectBoard = function selectBoard(state) {
  return state.board.map(function (c) {
    return {
      id: c.id,
      contents: c.contents
    };
...
var selectVisibleIDs = function selectVisibleIDs(state) {
  return state.board.filter(function (c) {
    return c.visible;
  }).map(function (_ref) {
    var id = _ref.id;
    return id;
...
var Card = function Card(_ref) {
  ...
  if (visibleIDs.some(function (cid) {
    return id === cid;
  })) {
    cardText = contents;
  ...
  if (matchedIDs.some(function (cid) {
    return id === cid;
  }) || visibleIDs.some(function (cid) {
    return id === cid;
  })) {
    cardStyle = 'matched';
  } // 3rd if statement
  ...
  return /*#__PURE__*/_react["default"].createElement("button", {
    onClick: click,
    className: "card ".concat(cardStyle, " ").concat(noMatch)
  }, cardText);
};
